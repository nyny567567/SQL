...
SELECT
    ...
    d.department_name --name이었으면 좀더 좋았다
FROM employees e
INNER JOIN departments d
...
ORDER BY e.first_name ASC;  --생략가능(오름차순)
...
SELECT *
FROM JOBS j 
LEFT JOIN JOB_HISTORY jh --outer 생략 가능 
...
SELECT *
FROM employees e
CROSS JOIN departments d; --2889개 컨트롤 + 엔드
...
문제 11. 
--6. EMPLOYEES 테이블에서 left join하여 관리자(매니저)ID와, 매니저의 이름, 매니저의 급여 까지 출력하세요
